...
class CreateUserResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["userId", "username", "books"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CreateUserResult from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CreateUserResult from a dict"""
        if obj is None:
            return None
